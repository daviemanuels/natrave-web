    ...
    return (
        <div className="rounded-xl border border-gray-300 p-4 text-center space-y-4">
            ...
            <form className="flex space-x-4 justify-center items-center">
                ...
                <img src={`./images/bandeiras/${homeTeam}.png`} alt="" srcset="" />

                <input 
                    className="bg-red-300/[0.2] w-14 h-14 text-red-700 text-xl text-center rounded-full"
                    type="number" 
                    name="homeTeamScore"
                ...
                <img src={`./images/bandeiras/${awayTeam}.png`} alt="" srcset="" />
